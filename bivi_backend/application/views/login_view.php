            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url('index.php/index/cek_login') ?>" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Username" autofocus name="username">
                                </div>
                                <div class="form-group">
                                ...
                                <a href="<?php echo base_url('index.php/index/index') ?>" class="btn btn-lg btn-warning btn-block">Kembali</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
